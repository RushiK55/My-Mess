...
@HiltViewModel
class OwnerCloudMealsViewModel @Inject constructor(
    ...
    fun load() {
        ...
        viewModelScope.launch {
            ...
            _mealsState.value = ownerRepository.getOwnerCloudMeals(ownerUid)
        }
    }
    ...
    fun saveMeal(mealId: String?, name: String, description: String, price: Double, imageUrl: String?) {
        ...
        viewModelScope.launch {
            ...
            _actionState.value = ownerRepository.saveCloudMeal(ownerUid, meal)
            load()
        }
    }
    ...
    fun toggleAvailability(meal: Meal) {
        ...
        viewModelScope.launch {
            _actionState.value = Resource.Loading
            _actionState.value = ownerRepository.saveCloudMeal(ownerUid, meal.copy(isAvailable = !meal.isAvailable))
            load()
        }
    }
